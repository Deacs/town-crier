...
@section('content')
    <div class="admin">
        ...
        <h3><span class="glyphicon glyphicon-wrench"></span> Edit {{ $user->fullName() }}'s details</h3>

         <form action="/admin/user/edit" id="add-user" method="POST" class="form-horizontal">
...
<script>
        ...
        var respond = function(response) {
            ...
            var data = {
                type: "success",
                title: "User Updated!",
                text: "The user's details are all shiny and new.",
            };
            if (response != 'pass') {
                data = {
                    type: "error",
